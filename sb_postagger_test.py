...
print("Evaluation: {:.1%}".format(default_tagger.evaluate(test_sents)))
...
print("Evaluation: {:.1%}".format(unigram_tagger.evaluate(test_sents)))
print("Elapsed time: {:.0f} s".format(time.process_time() - start_time))
print()
...
print("Evaluation: {:.1%}".format(bigram_tagger.evaluate(test_sents)))
print("Elapsed time: {:.0f} s".format(time.process_time() - start_time))
print()
...
print("Evaluation: {:.1%}".format(affix_tagger.evaluate(test_sents)))
print("Elapsed time: {:.0f} s".format(time.process_time() - start_time))
print()
...
print("Evaluation, affix   backoff tagger: {:.1%}".format(t0.evaluate(test_sents)))
print("Evaluation, unigram backoff tagger: {:.1%}".format(t1.evaluate(test_sents)))
print("Evaluation, bigram  backoff tagger: {:.1%}".format(t2.evaluate(test_sents)))
print("Evaluation, trigram backoff tagger: {:.1%}".format(t3.evaluate(test_sents)))
print("Elapsed time: {:.0f} s".format(time.process_time() - start_time))
print()
